 ...
 * @author liamvr
 */
public class hotelCalculator extends javax.swing.JFrame {

    /**
     * Creates new form hotelCalculator
     */
    public hotelCalculator() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Hotel Calculator");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(hotelCalculator.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new hotelCalculator().setVisible(true);
            }
        });
    }
